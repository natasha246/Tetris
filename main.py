...
pygame.time.set_timer(GAME_UPDATE, 425)
...
while True:
    ...
    pygame.draw.rect(screen, Colours.dark_grey, score_rect, 0, 10)
    screen.blit(score_value_surface, score_value_surface.get_rect(centerx = score_rect.centerx, centery = score_rect.centery))
    pygame.draw.rect(screen, Colours.dark_grey, next_rect, 0, 10)
    game.draw(screen)
